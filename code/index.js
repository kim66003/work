...
survey
    ...
    //   if (xhr.status == 200) {
    //   options.showDataSavingSuccess("Resultaten zijn opgeslagen!"); //you may pass a text parameter to show your own text
    //   //Or you may clear all messages
    //   //options.showDataSavingClear();
    //   } else {
    //   //Error
    //   options.showDataSavingError("Er is iets mis gegaan bij het opslaan van de resultaten.."); //you may pass a text parameter to show your own text
    //   }
    //   };
